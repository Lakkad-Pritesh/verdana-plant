...
const blogPosts = [
  { id: 1, title: 'The Ultimate Guide to Monstera Care', category: 'Care Guides', date: 'Mar 15, 2026', image: '../../public/images/blog0.webp', excerpt: 'Learn how to keep your Monstera Deliciosa thriving with these expert tips on watering, light, and propagation.' },
  { id: 2, title: 'Top 5 Air-Purifying Plants for Your Bedroom', category: 'Wellness', date: 'Mar 10, 2026', image: '../../public/images/blog1.jpg', excerpt: 'Breathe easier and sleep better by adding these natural air purifiers to your nighttime sanctuary.' },
  { id: 3, title: 'Pet-Friendly Plants: A Safe Indoor Jungle', category: 'Guides', date: 'Mar 05, 2026', image: '../../public/images/blog2.jpg', excerpt: 'Create a lush indoor garden without worrying about your furry friends. Here are our top non-toxic plant picks.' },
  { id: 4, title: 'Decorating with Large Statement Plants', category: 'Styling', date: 'Feb 28, 2026', image: '../../public/images/blog3.jpg', excerpt: 'Make a bold impact in any room by incorporating large, architectural plants like the Bird of Paradise or Olive Tree.' },
  { id: 5, title: 'Winter Plant Care: What You Need to Know', category: 'Care Guides', date: 'Feb 15, 2026', image: '../../public/images/blog4.jpg', excerpt: 'Adjust your watering schedule and protect your tropicals from drafts with our comprehensive winter survival guide.' },
